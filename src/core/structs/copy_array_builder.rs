...
/// ```
#[derive(Copy)]
pub struct CopyArrayBuilder<T, const N: usize> {
    buf: [MaybeUninit<T>; N],
    len: usize,
}

impl<T: Clone, const N: usize> Clone for CopyArrayBuilder<T, N> {
    fn clone(&self) -> Self {
...
impl<T: fmt::Debug, const N: usize> fmt::Debug for CopyArrayBuilder<T, N> {
...
impl<T, U, const N: usize> cmp::PartialEq<CopyArrayBuilder<U, N>> for CopyArrayBuilder<T, N>
where
    T: cmp::PartialEq<U>,
{
    fn eq(&self, other: &CopyArrayBuilder<U, N>) -> bool {
        self.deref() == other.deref()
    }
}
impl<T: cmp::Eq, const N: usize> cmp::Eq for CopyArrayBuilder<T, N> {}
impl<T: cmp::PartialOrd, const N: usize> cmp::PartialOrd for CopyArrayBuilder<T, N> {
    fn partial_cmp(&self, other: &Self) -> Option<cmp::Ordering> {
        self.deref().partial_cmp(other.deref())
    }
}
impl<T: cmp::Ord, const N: usize> cmp::Ord for CopyArrayBuilder<T, N> {
    fn cmp(&self, other: &Self) -> cmp::Ordering {
        self.deref().cmp(other.deref())
    }
}

impl<T, const N: usize> Deref for CopyArrayBuilder<T, N> {
    type Target = [T];
    fn deref(&self) -> &[T] {
...
impl<T, const N: usize> DerefMut for CopyArrayBuilder<T, N> {
    fn deref_mut(&mut self) -> &mut [T] {
        unsafe { slice::from_raw_parts_mut(self.as_mut_ptr(), self.len) }
    }
}

impl<T, const N: usize> From<[T; N]> for CopyArrayBuilder<T, N> {
...
impl<T, const N: usize> CopyArrayBuilder<T, N> {
